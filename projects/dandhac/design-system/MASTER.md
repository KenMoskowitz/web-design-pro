# D&H Heating & Air Conditioning — Design System
...
**Descriptors:** trusted family-owned premium
...
| Token            | Hex                | Usage                                    |
| ---------------- | ------------------ | ---------------------------------------- |
| `brand-primary` | `#0E2A47` | Hero background, primary CTA fill        |
| `brand-accent`  | `#E8731A`  | One highlight per section, link hover    |
| `brand-dark`    | `#0A1F36`    | Body headings, footer background         |
| `brand-light`   | `#F7F4EE`   | Page background, card fills              |
...
- **Display:** `Manrope` — weights 600, 700. Used for `h1`, `h2`, hero numbers.
