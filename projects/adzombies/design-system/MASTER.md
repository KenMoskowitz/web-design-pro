# Ad Zombies — Design System

> **Source:** vibe preset `bold-modern`. When `ui-ux-pro-max`'s `search.py --design-system` is available, replace this file with its output and add the rationale block from its response.

**Industry:** ad creative and production studio
**Descriptors:** irreverent bold AI-era street-cred
...
`bold-modern` — see `docs/SOP.md` for what this preset commits to in tone, density, and animation rhythm.
...
| Token            | Hex                | Usage                                    |
| ---------------- | ------------------ | ---------------------------------------- |
| `brand-primary` | `#0a0a0a` | Hero background, primary CTA fill        |
| `brand-accent`  | `#7CFC00`  | One highlight per section, link hover    |
| `brand-dark`    | `#0a0a0a`    | Body headings, footer background         |
| `brand-light`   | `#f5f5f5`   | Page background, card fills              |
...
- **Display:** `Bungee` — weights 600, 700. Used for `h1`, `h2`, hero numbers.
