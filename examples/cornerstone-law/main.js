/* Cornerstone Law (DEMO) — animations + interactions.
 * GSAP + ScrollTrigger are vendored locally in this example so it works offline.
 * Production templates load them from cdn.jsdelivr.net.
 */
(function () {
  'use strict';
